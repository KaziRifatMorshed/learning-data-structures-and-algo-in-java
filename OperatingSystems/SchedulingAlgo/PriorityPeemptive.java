...
class PriorityPreemptive {
    ...
    public static void main(String[] args) {
        ...
        priorityPreemptive.addProcess(p1);
        priorityPreemptive.addProcess(p2);
        priorityPreemptive.addProcess(p3);
        priorityPreemptive.addProcess(p4);
        priorityPreemptive.addProcess(p5);
        priorityPreemptive.exec();
    }
